...
print ('''
                          ...
                          <<<<< Coded By HamZsaja & Cinta >>>>>                       
                          
┌─────────────────────────────────────────────┐
│        Hello Welcome To Squid C2 :)     │
├─────────────────────────────────────────────┤
│               Silahkan Login:                         │
│          [+] Username :)                       │
│          [+] Password :)                       │
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] CintaCans C2 | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [Cinta] | POWER : {}% [UNSTABLE]\x07".format (powerran))


		sin = input("\033[0;36m{}\033[0;34m@[C2 Cinta]\033[36m--> \033[0;31m".format(nicknm)).lower()
